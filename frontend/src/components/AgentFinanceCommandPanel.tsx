...
export default function AgentFinanceCommandPanel({
    snapshot,
    accent,
    visuals,
    attention,
    ...
    const register = extractVendorRegister(visuals, 8);
    ...
    return (
        <div className="space-y-5">
            ...
            >
                ...
                {!isEmpty && (
                    <div className="flex flex-wrap gap-4 mt-4 pt-4 border-t border-border/50">
                        {[
                            { label: "AP spend", value: fmtAp },
                            { label: "Vendors", value: snapshot.stats.vendorCount || "—" },
                            {
                                label: "Overdue AP",
                                value:
                            ...
                            },
                            {
                                ...
                                value: snapshot.stats.missingAmountCount || "—",
                            },
                        ].map((s) => (
                            <div key={s.label}>
                ...
                {isEmpty && (
                    ...
                    >
                        <Upload size={15} /> Upload finance documents
                    </Link>
                )}
            </div>
            ...
            {register.length > 0 && (
                <AgentFinanceRegisterTable rows={register} accent={accent} onAsk={onAsk} />
            )}
