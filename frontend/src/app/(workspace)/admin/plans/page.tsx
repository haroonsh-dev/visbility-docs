                ...
                {TABS.map((t) => (
                    <button
                        ...
                        className={`relative px-4 py-2.5 text-sm font-medium whitespace-nowrap transition-colors ${
                            tab === t ? "text-teal-700" : "text-slate-500 hover:text-slate-700"
                        }`}
                    >
                        {TAB_META[t]}
                        ...
                        {tab === t && (
                            <span className="absolute left-4 right-4 -bottom-px h-0.5 bg-teal-600 rounded-full" />
                        )}
                    </button>
                ))}
            </nav>
                            ...
                            return (
                                <button
                                    ...
                                    className={`relative px-3 py-2 text-xs font-medium capitalize whitespace-nowrap ${
                                        subFilter === f ? "text-teal-700" : "text-slate-500 hover:text-slate-700"
                                    }`}
                                >
                                    {f}
                                    <span className="ml-1 text-slate-400">{count}</span>
                                    {subFilter === f && (
                                        <span className="absolute left-3 right-3 -bottom-px h-0.5 bg-teal-600 rounded-full" />
                                    )}
                                </button>
                            );
                        })}
