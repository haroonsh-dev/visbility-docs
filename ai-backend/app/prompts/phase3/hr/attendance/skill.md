...
```json
{
  ...
  "required": ["period", "employee_name", "employee_id", "total_working_days", "days_present", "days_absent", "leaves_taken", "late_arrivals", "total_overtime_hours", "_field_confidence", "grounding"]
}
```
